...
int main() {
  ...
  bstree_eliminar(arbol, palabras[3], (FuncionComparadora)comparar_cadena, (FuncionDestructora)destruir_cadena);
  bstree_recorrer(arbol, BTREE_RECORRIDO_IN, imprimir_cadena, NULL);
  puts("");

  printf("%d\n", bstree_validar(arbol, NULL, NULL, (FuncionComparadora)comparar_cadena));
